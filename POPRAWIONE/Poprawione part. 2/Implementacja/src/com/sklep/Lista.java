...
public class Lista {
    ...
    public static Produkt2[] produkty = new Produkt2[listOfFiles.length+10];
    public static Produkt2[] zakupy = new Produkt2[listOfFiles.length+10];
